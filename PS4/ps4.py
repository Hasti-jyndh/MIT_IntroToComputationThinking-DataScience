...
class SimpleBacteria(object):
    ...
    def __init__(self, birth_prob, death_prob):
        ...
        """
        #birth_prob = random.randrange(0,1)
        #death_prob = random.randrange(0,1)
    ...
    def reproduce(self, pop_density):
        ...
        if reproduce_prob >= random.random():
            return SimpleBacteria(self.birth_prob,self.birth_prob)
        else:
...
class Patient(object):
    ...
    def update(self):
        ...
        for bac in survived_bacteria:
            try:
                child = bac.reproduce(population_density)
            except NoChildException:
                continue
            children.append(child)
        self.bacteria = survived_bacteria + children
        return len(self.bacteria)
...
def simulation_without_antibiotic(num_bacteria,
    ...
    for i in range(num_trials):
        ...
        for step in range(300):
            ...
            populations[i][step]=patient.update()
    return populations
...
def calc_pop_std(populations, t):
    ...
    for i in range(len(populations)):
        sum_squared += (mean - populations[i][t])**2
    return (sum_squared/len(populations))**0.5
