...
# For python 2.7:
# from ps3_verify_movement27 import test_robot_
...
class FurnishedRoom(RectangularRoom):
    ...
    def is_position_valid(self, pos):
        ...
        """
        if not self.is_position_furnished(pos) and self.is_position_valid(pos):
            return True
    ...
    def get_num_tiles(self):
        ...
        for tile in self.tiles:
            m,n = tile
            if not self.is_tile_furnished(m, n) and self.is_position_in_room(tile):
                count += 1
            return count
